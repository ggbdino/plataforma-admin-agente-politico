  ...
  try {
    ...
    await db.query(
      [
        ...
        "  case when $4::boolean then 'telefone_alterado_requer_regerar_qr' else null end,",
        ...
        "  pairing_qr_code_url = case when $4::boolean then null else implantacoes_candidato.pairing_qr_code_url end,",
        "  evolution_connection_code = case when $4::boolean then null else implantacoes_candidato.evolution_connection_code end,",
        "  evolution_pairing_code = case when $4::boolean then null else implantacoes_candidato.evolution_pairing_code end,",
        "  evolution_connection_status = case",
        "    when $4::boolean then 'telefone_alterado_requer_regerar_qr'",
